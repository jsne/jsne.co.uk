...
const IndexPage = () => [
    ...
    <HomeHero
        ...
        secondary={{
            ...
            infos: [
                <IconText key="date" theme="light" icon={<CalendarIcon />} text={<span>20<sup>th</sup> June</span>} />,
                <IconText key="time" icon={<ClockIcon />} text="6.00pm" />,
                <IconText key="venue" icon={<MapIcon />} text={<span className={linkClassName}>Jazz Cafe</span>} to="#venue-map" />,
            ],
        }}
        eventInfo={{
